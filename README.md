...
This mod and all the models were made by Red_King_Cyclops, but several textures and much of code was made by other users. Almost all of the code is modified code from Paramat's [airboat](https://forum.minetest.net/viewtopic.php?t=20485) mod. The texture "rocket.png" is actually "submarine.png" renamed, taken from the [submarine](https://forum.minetest.net/viewtopic.php?f=9&t=16282) modpack by krokoschlange. Additionally, the textures "rocket_boom.png" and "rocket_smoke.png" are renamed textures taken from tnt and "rocket_hull.png" is a renamed texture taken from default. The rest of the textures were made by me.